...
void main() 
{
  ...
  vec2 force = forceFromAngle(random(uv) * PI2 + time) * colorFbo.r - vec2(0.0, 1.0);
  ...
  vec4 color = updateBufferWithColorFilter(fadeOut(colorFbo, 0.95), vec4(1.0,0.2,0.0,1.0), filter, 1.0);
